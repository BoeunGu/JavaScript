...
userArray.forEach(i=>{
    ...
    for(let k=0;k<typeArray.length;k++){
        typeArray[k].forEach(j=>{
            if(!classified[j]){classified[j]=0}
        if(j==valueArray[k]){classified[j]++
        }

        })
    }
})
//     hairColors.forEach(j=>{
//         // console.log(1, j, classified[j])
        
//         // console.log(2, j, classified[j])
//     })
//     hairTypes.forEach(j=>{
//         if(!classified[j]){classified[j]=0}
//         if(j==valueArray[1]){classified[j]++
//         }
//     })
//     glasses.forEach(j=>{
//         if(!classified[j]){classified[j]=0}
//         if(j==valueArray[2]){classified[j]++
//         }
//     })
//     heights.forEach(j=>{
//         if(!classified[j]){classified[j]=0}
//         if(j==valueArray[3]){classified[j]++
//         }
//     })
//     weights.forEach(j=>{
//         if(!classified[j]){classified[j]=0}
//         if(j==valueArray[4]){classified[j]++
//         }
//     })
